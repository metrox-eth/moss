...
![Tracks on, 22 September](../media/images/build_tracks_on_20260922.jpg)
![Bin on, 22 September](../media/images/build_bin_on_20260922.jpg)
...
Numbers worth writing down while they are fresh, because a model copied often enough starts to look like a measurement. The physical prototype was weighed at 3.5 kg without the arm, cover (140 g) and bin (180 g) included, so about 3.18 kg bare. The 6.14 kg in the first MJCF export is an inertia computed from solid geometry, not a weighing. The camera's nominal front face sits at (156, 0, 75) mm in the rover frame, level; the 95 mm sometimes quoted is a mounting spacing, not its height. The reference SO-101 model totals 632 g; adding a 50 g allowance for the custom gripper gives about 682 g for the arm and gripper budget, or 4.18 kg including the measured base; the arm has not been weighed. The vertical centre of gravity, 75 mm, is estimated, and the "CG above the middle roller" observation was made without cover, bin or arm, so it does not apply to a loaded bin.
...
Weighed on 27 September, arm and gripper together, off the rover: 768 g. The 24 September note estimated 682 g from the reference SO-101 model plus a gripper allowance, so the estimate was 86 g light. Added to the base as weighed on 24 September (3.5 kg without the arm), that gives about 4.27 kg for the loaded rover, a sum, not a weighing; the assembled rover gets its own weighing once it is on the V0.4 hull. Part of the extra mass is the servos: this prototype's arm runs ST3235 salvaged from older arms, heavier than the ST3215 the parts list recommends; builders should take the ST3215.
