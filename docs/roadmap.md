...
- **Now (V0.1)**: print and assemble the prototype; every part that turns out odd or not optimal is corrected in the CAD right away, without reprinting. The corrected design is what gets published as **V0.3**, with the printable files and the fastener list. V0.1 is the bench prototype, not the release.
